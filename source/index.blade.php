        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="d-flex justify-content-center mb-4">
                    <img src="/assets/img/memoji.png" width="300">
                    {{--                    <svg class="my-4" xmlns="http://www.w3.org/2000/svg" width="92" height="128" fill="currentColor" viewBox="0 0 233 320" >--}}
...
{{--                    </svg>--}}
                ...
                <div class="card mb-2">
                    <div class="card-body text-center">
                        <a href="{{ $link->url }}" class="stretched-link text-dark text-decoration-none">{{ $link->title }}</a></div>
                </div>
                @endforeach
            </div>
        </div>
